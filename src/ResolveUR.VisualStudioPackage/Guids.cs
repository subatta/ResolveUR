...
namespace SreeEnterprises.ResolveURVisualStudioPackage
{
    static class GuidList
    {
        ...
        public static readonly Guid guidResolveURVisualStudioPackageCmdSet = new Guid(guidResolveURVisualStudioPackageCmdSetString);
    };
}